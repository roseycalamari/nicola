...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Update the display with the loaded stats
    updateStatsDisplay(stats);
    
    // Initialize the stats counter after data is loaded
    ...
    if (expandButton && expandedContent) {
        expandButton.addEventListener('click', () => {
            ...
            if (expandedContent.classList.contains('active')) {
                ...
                text.textContent = 'Less Stats';
            } else {
                icon.className = 'fas fa-chevron-down';
                text.textContent = 'More Stats';
            }
        });
    }
...
function initializeDonationForm() {
    ...
    donateButton.addEventListener('click', () => {
        ...
        window.location.href = 'https://donate.stripe.com/test_8wM6rv1Hk57F71m289';
    });
}
...
newsletterForms.forEach(form => {
    form.addEventListener('submit', async (e) => {
        ...
        if (emailInput && emailInput.checkValidity()) {
            // Show loading state
            submitButton.innerHTML = '<span>Subscribing...</span> <i class="fas fa-spinner fa-spin"></i>';
            submitButton.disabled = true;
            ...
            try {
                ...
                form.innerHTML = `
                    <div class="newsletter-success">
                        ...
                        <p>You've successfully joined my newsletter. I look forward to sharing my tennis journey with you.</p>
                    </div>
                `;
            } catch (error) {
                console.error('Error:', error);
